...
import {Learnsets as ChampionsLearnsets} from '../championsma/learnsets';
...
export const Learnsets: LearnsetTable = cloneTable(BaseLearnsets);
addMissingMoves(Learnsets, ChampionsLearnsets);
