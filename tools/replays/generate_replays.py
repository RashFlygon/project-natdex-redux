...
def generate(logs_dir: Path, output_dir: Path, base_url: str, embed_url: str, min_turns: int) -> int:
...
def main() -> None:
	...
	generated = generate(args.logs_dir, args.output_dir, args.base_url, args.embed_url, args.min_turns)
	print(f"Generated {generated} replay page(s).")
